...
public class StationSQLiteAdapter implements SQLiteAdapterBase<Zone> {
...
private static final String TAG = "ZoneDBAdapter";
	...
	public StationSQLiteAdapter(SQLiteDatabase db) {
		 this.db = db;
	}
	...
	public long insert(Zone item) {
		...
		ContentValues values = StationSQLiteAdapter.zoneToContentValues(item);
